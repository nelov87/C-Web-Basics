...
namespace SIS.WebServer
{
    public class ConnectionHandler
    {
        ...
        private IHttpResponse ReturnIfResource(IHttpRequest httpRequest)
        {
            ...
            string fullPathToResources = assemblyLocation + folderPrefix + resourceFolder + requestedResource;

            if (File.Exists(fullPathToResources))
            {
                byte[] content = File.ReadAllBytes(fullPathToResources);
